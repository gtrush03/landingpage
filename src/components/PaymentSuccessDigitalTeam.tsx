...
import { CheckCircle2, ArrowLeft, Mail, Phone, Bot, Users, Network, Shield, Target } from 'lucide-react';

export default function PaymentSuccessDigitalTeam() {
        ...
        <div className="max-w-2xl w-full space-y-8">
          ...
          <div className="bg-black/40 backdrop-blur-xl border border-[#928466]/30 rounded-2xl p-8 md:p-12">
            ...
            <div className="text-center space-y-6 mb-12">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#928466]/10 border border-[#928466]/30">
                <Network size={20} className="text-[#928466]" />
                <span className="text-[#928466] font-light">AI Digital Team Plan</span>
              </div>
            ...
            <div className="bg-[#928466]/10 border border-[#928466]/30 rounded-xl p-6 mb-12">
              <p className="text-center text-white/80">
                ...
                to begin implementing your custom AI workforce and optimization strategy.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-center">
            <div className="bg-black/40 backdrop-blur-xl rounded-xl p-6 border border-[#928466]/20">
              ...
              <p className="text-white/60">4 AI Employees</p>
            </div>
            <div className="bg-black/40 backdrop-blur-xl rounded-xl p-6 border border-[#928466]/20">
              <Shield size={24} className="text-[#928466] mx-auto mb-3" />
              <p className="text-white/60">Advanced Security</p>
            </div>
            <div className="bg-black/40 backdrop-blur-xl rounded-xl p-6 border border-[#928466]/20">
              <Target size={24} className="text-[#928466] mx-auto mb-3" />
              <p className="text-white/60">Custom Training</p>
            </div>
            <div className="bg-black/40 backdrop-blur-xl rounded-xl p-6 border border-[#928466]/20">
              <Users size={24} className="text-[#928466] mx-auto mb-3" />
              <p className="text-white/60">Team Integration</p>
            </div>
          </div>
        </div>
      </div>
